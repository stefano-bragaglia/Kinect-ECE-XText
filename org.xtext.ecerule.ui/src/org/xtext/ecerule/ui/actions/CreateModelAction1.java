 ...
 */
public class CreateModelAction1 implements IWorkbenchWindowActionDelegate {
	private IWorkbenchWindow window;
	/**
	 * The constructor.
	 */
	public CreateModelAction1() {
	}
	...
	public void run(IAction action) {
		...
		MessageDialog.openInformation(
			window.getShell(),
			"org.xtext.ecerule.ui",
			"Creation Rules Ok");
		
		System.out.println("Creation Rules Ok");
	}
