...
public final class TrackerHumanValues {
	...
	public static final int NEW_ORIGIN = SkeletonJoint.TORSO.ordinal(); // torso
	...
	public static final SkeletonJoint SKELETON_JOINT(int l) {
		SkeletonJoint sj = null;

		if (l == HEAD)
			sj = SkeletonJoint.HEAD;
		else if (l == NECK)
			sj = SkeletonJoint.NECK;
		else if (l == TORSO)
			sj = SkeletonJoint.TORSO;
		else if (l == RIGHT_SHOULDER)
			sj = SkeletonJoint.RIGHT_SHOULDER;
		else if (l == RIGHT_ELBOW)
			sj = SkeletonJoint.RIGHT_ELBOW;
		else if (l == RIGHT_HAND)
			sj = SkeletonJoint.RIGHT_HAND;
		else if (l == LEFT_SHOULDER)
			sj = SkeletonJoint.LEFT_SHOULDER;
		else if (l == LEFT_ELBOW)
			sj = SkeletonJoint.LEFT_ELBOW;
		else if (l == LEFT_HAND)
			sj = SkeletonJoint.LEFT_HAND;
		else if (l == RIGHT_HIP)
			sj = SkeletonJoint.RIGHT_HIP;
		else if (l == RIGHT_KNEE)
			sj = SkeletonJoint.RIGHT_KNEE;
		else if (l == RIGHT_FOOT)
			sj = SkeletonJoint.RIGHT_FOOT;
		else if (l == LEFT_HIP)
			sj = SkeletonJoint.LEFT_HIP;
		else if (l == LEFT_KNEE)
			sj = SkeletonJoint.LEFT_KNEE;
		else if (l == LEFT_FOOT)
			sj = SkeletonJoint.LEFT_FOOT;
		return sj;
	}
