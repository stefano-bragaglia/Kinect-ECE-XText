 ...
 * <ul>
 *   <li>{@link org.xtext.ecerule.ece.impl.ToRuleImpl#getExpression <em>Expression</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ToRuleImpl extends MinimalEObjectImpl.Container implements ToRule
{
  ...
  {
    return EcePackage.Literals.TO_RULE;
  }
  ...
  public NotificationChain basicSetExpression(StringExpr newExpression, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EcePackage.TO_RULE__EXPRESSION, oldExpression, newExpression);
  ...
  public void setExpression(StringExpr newExpression)
  {
    if (newExpression != expression)
    {
      ...
      if (expression != null)
        msgs = ((InternalEObject)expression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EcePackage.TO_RULE__EXPRESSION, null, msgs);
      if (newExpression != null)
        msgs = ((InternalEObject)newExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EcePackage.TO_RULE__EXPRESSION, null, msgs);
      msgs = basicSetExpression(newExpression, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EcePackage.TO_RULE__EXPRESSION, newExpression, newExpression));
  }
