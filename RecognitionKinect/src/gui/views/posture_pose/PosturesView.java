...
//		panel.setBackground(new Color(0,0,0));
	...
	public void actionPerformed(ActionEvent arg0) {
		// TODO Auto-generated method stub
		if (arg0.getSource() == ahead) { //aggiungi n. step esercizio
		...
		if (arg0.getSource() == back) { //riduci n. step esercizio
		...
		if (arg0.getSource() == go) { //vai a schermata sucessiva
			mb.showWO();
