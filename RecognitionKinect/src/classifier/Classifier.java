...
public class Classifier extends Observable {
	...
	public void classifyLimb(int limb) throws Exception {
		...
		//classifica l'arto (es: per il braccio dice se Ë alzato o abbassato)
		...
		//la classe con prob. pi˘ alta determina clsLabel
		double distr[] = limbNET[limb].distributionForInstance(skeletonIstance
				.get(limb));
		//valore di prob (il pi˘ alto quindi) con il quale ho classificato
